...
context transaction {
     ...
     entity purchaseorder: common.Amount, cuid {
            PO_ID: Integer;     	
            PARTNER_GUID: association to master1.businesspartner;                      
     ...
     entity poitems: common.Amount, cuid {
            ...
            PO_ITEM_POS: Integer;	
            PRODUCT_GUID: association to master1.product;           	
...
context CDSViews {
 ...
 define view ProductValueHelp as 
    ...
    select from master1.product as prod{
        PRODUCT_ID as![ProductId],
    ...
    define view ProductView as select from master1.product
    mixin{
